...
#'
#' @description M-model implementation of the spatially non-structured multivariate latent effect using the \code{rgeneric} model of INLA.
#'
#' @details This function considers a spatially non-structured prior for the spatial latent effects of the different diseases and introduces correlation between them using the M-model proposal of \insertCite{botella2015unifying;textual}{bigDM}.
